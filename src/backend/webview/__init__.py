...
def create_file_filter(file_patterns):
    """
    Create a file filter based on an list of supported file_patterns

    :param file_patterns: list of supported file patterns as wildcard strings:
        e.g: ['*.png', '*.jpeg']
    """
    return gui.create_file_filter(file_patterns)


def create_file_dialog(dialog_type=OPEN_DIALOG, directory='', allow_multiple=False, file_filter=None, save_filename=''):
    """
    ...
    try:
        ...
        return gui.create_file_dialog(dialog_type, directory, allow_multiple, file_filter, save_filename)

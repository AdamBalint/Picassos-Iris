...
class BrowserView:
    ...
    def create_file_dialog(self, dialog_type, directory, allow_multiple, file_filter, save_filename):
        def create_dialog(*args):
            ...
            if dialog_type == SAVE_DIALOG:
                ...
                if (file_filter):
                    print(file_filter)
                    open_dlg.setAllowedFileTypes_(file_filter)
...
def create_file_dialog(dialog_type, directory, allow_multiple, file_filter, save_filename):
    return BrowserView.instance.create_file_dialog(dialog_type, directory, allow_multiple, file_filter, save_filename)
...
def create_file_filter(file_types):
    return file_types

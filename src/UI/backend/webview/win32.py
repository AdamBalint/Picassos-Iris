    ...
    def create_file_dialog(self, dialog_type, directory, allow_multiple, save_filename):
        ...
        try:
            if dialog_type == FOLDER_DIALOG:
                ...
                file_filter = localization["windows.fileFilter.allFiles"] +
                localization["windows.fileFilter.imageFiles"]

                custom_filter = localization["windows.fileFilter.otherFiles"] +
                localization["windows.fileFilter.imageFiles"]
